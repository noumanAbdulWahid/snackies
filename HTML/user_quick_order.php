...
if (isset($_POST['quick_order_submit'])) {
    ...
    header("location:../HTML/user_quick_order.php");
}
?>

<head>
    <link rel="stylesheet" href="../CSS/user_quick_order.css">
...
<body>
    <header>
        ...
        <nav class="nav-bar">
            ...
            <a class="active" href="../HTML/user_quick_order.php">Quick Order</a>
            ...
            ?>
                    <div class="cart-content">
                        <div class="cart-box">
                            ...
                            <a href="user_quick_order.php?delete=<?php echo $fetch_cart['id']; ?>" class="fas fa-trash-alt" id="trash"></a>
                        </div>
